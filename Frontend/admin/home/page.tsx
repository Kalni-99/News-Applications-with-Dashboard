        ...
        <div className="min-h-screen bg-gray-100">
            ...
            <nav className="bg-white p-4 shadow-md">
                <div className="container mx-auto flex justify-between items-center">
                    ...
                    <div>
                        <a href="#" className="mr-4 text-gray-700 hover:text-gray-900">Dashboard Home</a>
                ...
                {newsData.map(article => (
                    <div key={article.id} className="border p-4 rounded-md space-y-4">
                        ...
                        <div className="flex justify-end space-x-4">
                            ...
                            <a href={`/article/edit?${article.id}`} className="text-indigo-600 hover:text-indigo-800">Edit</a>
                            <a href={`/article/delete?${article.id}`} className="text-red-600 hover:text-red-800">Delete</a>
                        </div>
                    </div>
                ))}
            </div>
